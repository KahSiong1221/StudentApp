...
public class GymDatabaseManager extends SaDbManager {
    ...
    void addUser(User u) {
        ...
        values.put(KEY_NAME, u.getUserName()); // get users name
        values.put(KEY_EMAIL, u.getEmail()); // get users email
        values.put(KEY_PHONE_NO, u.getPhoneNo()); // get users phone no
    ...
    void addUserBooking(User u, DayTimeslot dTm) {
        ...
        initValues.put(KEY_USER_ID, u.getUserId());
