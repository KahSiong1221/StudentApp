...
public class computerFragment extends ListFragment{
   ...
   private int user_id;
    private String bookingType = "Computer";
   ...
   SharedPreferences sharedPreferences;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.library_fragment_computer,container,false);

        ListView mylist = (ListView)v.findViewById(android.R.id.list);
            myComputerbookingAdapter myAdapter = new myComputerbookingAdapter(getContext(),R.layout.library_my_booking,myComputerBookings);
            ...
            if(currentComputerBooking != null) {
                ...
                mybookingStatusButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("BookingName", currentComputerBooking.getComputerName());
