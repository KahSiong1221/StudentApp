...
import static com.example.studentapp_eoc_soc.SaDbHelper.KEY_PHONE_NO;
...
import static com.example.studentapp_eoc_soc.SaDbHelper.KEY_COMPUTER_BOOKING_STATUS;
...
public class LibraryDBManager extends SaDbManager {
    ...
    public void addComputerBooking(String Name,String startTime, String endTime, String Date, String Status, int CID, int UID){
        ...
        values.put(KEY_COMPUTER_BOOKING_STATUS, Status); //
    ...
    public void addRoomBooking(String Name,String startTime, String endTime, String Date, String Status, int CID, int UID){
        ...
        values.put(KEY_ROOM_BOOKING_STATUS, Status); //
