...
public class roomFragment extends ListFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myRoombookingAdapter myAdapter = new myRoombookingAdapter(getContext(),R.layout.mybooking,myRoomBookings);
    ...
    class myRoombookingAdapter extends ArrayAdapter<roombooking> {
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ...
            if(currentRoomBooking != null) {
                ...
                mybookingNameText.setText("ID: "+ currentRoomBooking.getComputerName());
