...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookSlotButton.setOnClickListener(new View.OnClickListener() {
                ...
                Intent ChooseBookingintent = new Intent(MainActivity.this, ChooseBookingActivity.class);
        ...
        viewBookingButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent ChooseBookingintent = new Intent(MainActivity.this, viewMyBookingActivity.class);
                startActivity(ChooseBookingintent);
            }
        });
