...
public class SaDbHelper extends SQLiteOpenHelper {
    ...
    protected static final String KEY_COMPUTER_BOOKING_STATUS = "computerBookingStatus";
    ...
    protected static final String KEY_ROOM_BOOKING_STATUS = "roomBookingStatus";
